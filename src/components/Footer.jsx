...
const Footer = () => {
  return (
    <>
      {/* <footer className="relative overflow-hidden justify-center z-10 bg-custom-pri  pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-custom-sec dark:text-dark-6">
                  Final note from CEO OF AS You have two options. Failure is the
                  soil by in which the seeds of success grow. And at WCU, There
                  are no failures.
                </p>
  ...
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="mb-10 w-full">
          <h4 className="mb-9 text-lg font-semibold text-dark text-custom-ter">
            {header}
          </h4>
...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-base leading-loose text-custom-sec hover:text-custom-ter "
      >
        {label}
      </a>
    </li>
